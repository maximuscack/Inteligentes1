...
#--------------------------------------------------------------------------------
#falta que reconozca los sitios turisticos  y si es asi, probablemente tampoco tonme en cuenta las luces
# Implementación del algoritmo BFS para encontrar un camino que pase por todos los sitios turísticos

def bfs_turisticos(G, origen):
    visitados = set()  # Conjunto de nodos visitados
    turisticos = set()  # Conjunto de nodos turísticos
    
    # Verificar si hay nodos turísticos en el grafo
...
camino_turisticos = bfs_turisticos(G, inicio)
